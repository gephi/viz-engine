...
public class IndirectNodeData extends AbstractNodeData {
    ...
    private void initBuffers() {
        ...
        commandsGLBuffer.bind();
        commandsGLBuffer.init(INDIRECT_DRAW_COMMAND_INTS_COUNT * Integer.BYTES * BATCH_NODES_SIZE * 2, GLBufferMutable.GL_BUFFER_USAGE_DYNAMIC_DRAW);
        commandsGLBuffer.unbind();
