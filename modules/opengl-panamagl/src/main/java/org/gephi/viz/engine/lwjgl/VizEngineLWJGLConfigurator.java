 ...
 */
public class VizEngineLWJGLConfigurator implements VizEngineConfigurator<PanamaGLRenderingTarget, LWJGLInputEvent> {

    @Override
    public void configure(VizEngine<PanamaGLRenderingTarget, LWJGLInputEvent> engine) {
