 ...
 */
public class PanamaGLRenderingTargetAWT implements PanamaGLRenderingTarget {

    private final Consumer<Integer> fpsCallback;
    private final boolean isWindows;
    private VizEngine engine;

    public PanamaGLRenderingTargetAWT(Consumer<Integer> fpsCallback) {
        this.fpsCallback = fpsCallback;
        this.isWindows = Platform.get() == Platform.WINDOWS;
    }

    public PanamaGLRenderingTargetAWT() {
        this(null);
    }
    ...
    public void reshape(final GLCanvasAWT canvas) {
