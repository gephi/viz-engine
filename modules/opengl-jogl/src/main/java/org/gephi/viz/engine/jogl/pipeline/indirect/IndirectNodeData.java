...
public class IndirectNodeData extends AbstractNodeData {
    ...
    private void updateData(final float zoom, final GraphIndexImpl spatialIndex, final GraphRenderingOptions renderingOptions, final GraphSelection selection) {
